...
module.exports = Core;
},{"./defaults":4,"./gallery":6,"./instapi":8,"./jquery":22,"./lang":23,"./popup":26,"./u":29,"./views":30}],4:[function(require,module,exports){
"use strict";
module.exports = {
    api: null,
    clientId: null,
    ...
    colorPopupUsername: 'rgb(0, 0, 0)',
    colorPopupUsernameHover: 'rgb(56, 151, 240)',
    colorPopupInstagramLink: 'rgb(56, 151, 240)',
    colorPopupInstagramLinkHover: 'rgb(38, 141, 234)',
    colorPopupCounters: 'rgb(109, 109, 109)',
    colorPopupPassedTime: 'rgb(152, 152, 152)',
    colorPopupAnchor: 'rgb(17, 60, 110)',
    colorPopupAnchorHover: 'rgb(56, 151, 240)',
    colorPopupText: 'rgb(52, 52, 52)',
...
},{"./api":1,"./core":3,"./defaults":4,"./instashow":21,"./jquery":22}],6:[function(require,module,exports){
"use strict";
...
$.extend(Gallery.prototype, {
    ...
    initialize: function () {
        ...
        if (self.options.responsive) {
            ...
            if ($.isPlainObject(self.options.responsive) || $.isArray(self.options.responsive)) {
                $.each(self.options.responsive, function (minWidth, grid) {
                    minWidth = parseInt(grid.minWidth ? grid.minWidth : minWidth, 10);
            ...
            self.core.mediaFetcher.fetch(self.grid.countCells()).done(function (list) {
                ...
                $.each(list, function (i, media) {
                    ...
                    if (media.type === 'carousel') {
                        $media.addClass('instashow-gallery-media-carousel');
                    }
...
},{"./auto-rotator":2,"./grid":7,"./jquery":22,"./loader":24,"./move-control":25,"./scrollbar":27,"./translations":28,"./u":29,"./views":30}],7:[function(require,module,exports){
"use strict";
var $ = require('./jquery');
...
module.exports = Grid;
},{"./jquery":22}],8:[function(require,module,exports){
"use strict";
var $ = require('./jquery'), Client = require('./instapi/client'), CacheProvider = require('./instapi/cache-provider'), UserProfileFetcher = require('./instapi/user-profile'), UserMediaFetcher = require('./instapi/user-media-fetcher'), TagMediaFetcher = require('./instapi/tag-media-fetcher'), ComplexMediaFetcher = require('./instapi/complex-media-fetcher'), SpecificMediaFetcher = require('./instapi/specific-media-fetcher'), LocationMediaFetcher = require('./instapi/location-media-fetcher');
...
},{"./instapi/cache-provider":9,"./instapi/client":10,"./instapi/complex-media-fetcher":11,"./instapi/location-media-fetcher":12,"./instapi/specific-media-fetcher":16,"./instapi/tag-media-fetcher":17,"./instapi/user-media-fetcher":18,"./instapi/user-profile":19,"./jquery":22}],9:[function(require,module,exports){
"use strict";
var $ = require('../jquery');
...
$.extend(Client.prototype, {
    ...
    send: function (path, params, options, expired, ignoreErrors) {
        var self = this;
        params = params || {};
        options = options || {};
        ...
        if (options.type === 'get' && expired && self.cacheProvider.has(url, expired)) {
            ...
            $.ajax(options).done(function (res) {
                if (res.meta.code === 200 || ignoreErrors) {
    ...
    get: function (path, params, options, expired, ignoreErrors) {
        var self = this;
        options = $.extend(false, options || {}, { type: 'get' });
        return self.send(path, params, options, expired, ignoreErrors);
    },
...
},{"../jquery":22,"../u":29}],11:[function(require,module,exports){
"use strict";
var $ = require('../jquery');
...
},{"../jquery":22,"./media-fetcher":13}],13:[function(require,module,exports){
"use strict";
var $ = require('../jquery'), Media = require('./media'), UserProfile = require('./user-profile');
...
$.extend(MediaFetcher.prototype, {
    ...
    load: function () {
        ...
        if (!self.hasNextMedia) {
            ...
            self.client.get(path, params, null, self.client.instapi.core.options.cacheMediaTime).done(function (result) {
                ...
                self.filterData(result.data).then(function (result) {
                    result.data = result;
                    q.resolve(result);
                });
            }).fail(function () {
    ...
    filterData: function (data) {
        ...
        $.each(self.filters, function (i, f) {
            ...
            if (f.type == 'user') {
                if (typeof filters[f.type][f.logic + 'ById'] === 'undefined') {
                    filters[f.type][f.logic + 'ById'] = [];
                }
                userCalls.push(UserProfile.get(self.client, name).done(function (data) {
                    filters[f.type][f.logic + 'ById'].push(data.id);
                }));
            }
        });
        $.when.apply($, userCalls).always(function () {
            q.resolve(data.filter(function (item) {
                var flag = true;
                $.each(filters, function (type, d) {
                    ...
                    case 'tag':
                        ...
                        break;
                    case 'user':
                        flag &= !d.only || !!~d.onlyById.indexOf(item.user.id);
                        flag &= !d.except || !~d.exceptById.indexOf(item.user.id);
                        break;
                    case 'location':
                        if (item.location) {
...
},{"../jquery":22,"./media":14,"./user-profile":19}],14:[function(require,module,exports){
"use strict";
...
},{"../jquery":22,"../u":29,"./model":15}],15:[function(require,module,exports){
"use strict";
var $ = require('../jquery');
...
},{"../jquery":22,"./media-fetcher":13}],17:[function(require,module,exports){
"use strict";
var $ = require('../jquery'), MediaFetcher = require('./media-fetcher');
...
},{"../jquery":22,"./media-fetcher":13}],18:[function(require,module,exports){
"use strict";
...
},{"../jquery":22,"./media-fetcher":13,"./user":20}],19:[function(require,module,exports){
"use strict";
var $ = require('../jquery'), Model = require('./model');
var UserProfile = function (client) {
    var self = this;
...
$.extend(UserProfile, Model, {
    ...
    get: function (client, name) {
        var q = $.Deferred();
        client.get('/users/' + name + '/', {}, {}, undefined, true).done(function (result) {
            if (!!result.data) {
...
$.extend(UserProfile.prototype, Model.prototype, { constructor: UserProfile });
module.exports = UserProfile;
},{"../jquery":22,"./model":15}],20:[function(require,module,exports){
"use strict";
var $ = require('../jquery'), Model = require('./model');
...
module.exports = User;
},{"../jquery":22,"./model":15}],21:[function(require,module,exports){
"use strict";
var $ = require('./jquery');
...
var languages = {
        ...
        'fi': {
            'View on Instagram': 'N\xe4yt\xe4 Instagramissa',
            'w': 'vk',
            'd': 'pv',
            'h': 't',
            'm': 'min',
        ...
        'vn': {
            'View on Instagram': 'Xem tr\xean Instagram',
            'w': 'tu\u1ea7n',
            'd': 'ng\xe0y',
            'h': 'gi\u1edd',
            'm': 'ph\xfat',
...
},{"./jquery":22}],26:[function(require,module,exports){
"use strict";
...
$.extend(Popup.prototype, {
    ...
    createMedia: function (media) {
        ...
        tplData.options.isImage = media.type === 'image';
        tplData.options.isVideo = media.type === 'video';
        tplData.options.isCarousel = media.type === 'carousel';
        tplData.options.hasInfo = tplData.options.username || tplData.options.instagramLink || tplData.options.hasLocation || tplData.options.likesCounter || tplData.options.commentsCounter || tplData.options.passedTime || tplData.options.description || tplData.options.comments;
        ...
        var $infoContainer = $media.find('.instashow-popup-media-info-container');
        if (self.core.instapi.client.isAlternativeApi()) {
            var specificMediaFetcher = new SpecificMediaFetcher(self.core.instapi.client, 'specific_media_shortcode', media.code, []);
            self.core.instapi.client.setDisplayErrors(false);
            specificMediaFetcher.fetch().done(function (result) {
                var specificMedia = result[0];
                if (specificMedia.type === 'video') {
                    $media.find('.instashow-popup-media-video video').attr('src', specificMedia.video_url);
                }
                if (specificMedia.type === 'carousel') {
                    var $carousel = $media.find('.instashow-popup-media-carousel');
                    console.log(specificMedia);
                    $carousel.append(self.createMediaCarousel(specificMedia));
                }
                $infoContainer.append(self.createMediaInfo(specificMedia));
                self.core.instapi.client.setDisplayErrors(true);
                $media.addClass('instashow-popup-media-info-loaded');
            });
        } else {
            if (media.type === 'carousel') {
                var $carousel = $media.find('.instashow-popup-media-carousel');
                $carousel.append(self.createMediaCarousel(media));
            }
            $infoContainer.append(self.createMediaInfo(media));
            $media.addClass('instashow-popup-media-info-loaded');
        }
        return $media;
    },
    createMediaCarousel: function (media) {
        var self = this;
        var tplData = {
                media: media,
                options: {}
            };
        return views.popup.mediaCarousel(tplData);
    },
    createMediaInfo: function (media) {
        var self = this;
        var tplData = {
                media: media,
                options: {},
        ...
        tplData.comments = self.createMediaComments(media);
        return views.popup.mediaInfo(tplData);
    },
    createMediaComments: function (media) {
        if (!media.comments) {
            return '';
        }
        var commentsList = $.extend(true, [], media.comments.data || []);
        commentsList.map(function (comment) {
            comment.text = u.nl2br(Instapi.parseAnchors(comment.text));
            return comment;
        });
        return views.popup.mediaComments({ list: commentsList });
    },
    ...
    watch: function () {
        ...
        self.$root.on('click', '.instashow-popup-media-carousel-nav-item', function (e) {
            if (!self.$media) {
                return false;
            }
            self.$media.find('.instashow-popup-media-carousel-nav-item').removeClass('instashow-popup-media-carousel-nav-item-active');
            $(this).addClass('instashow-popup-media-carousel-nav-item-active');
            var $mediaPicture = self.$media.find('.instashow-popup-media-picture');
            $mediaPicture.removeClass('instashow-popup-media-picture-loaded').removeAttr('src');
            var imageUrl = $(this).attr('data-media-url');
            var img = new Image();
            img.src = imageUrl;
            img.onload = function () {
                $mediaPicture.addClass('instashow-popup-media-picture-loaded');
                $mediaPicture.find('img').attr('src', imageUrl);
                self.$media.css('transition-duration', '0s').toggleClass('instashow-popup-media-hr', img.width >= 1080);
                self.$media.width();
                self.$media.css('transition-duration', '');
                self.adjust();
            };
        });
    }
...
},{"./instapi":8,"./instapi/media":14,"./instapi/specific-media-fetcher":16,"./jquery":22,"./u":29,"./views":30}],27:[function(require,module,exports){
"use strict";
...
},{"./jquery":22,"./views":30}],28:[function(require,module,exports){
"use strict";
var $ = require('./jquery');
var translateTimer;
module.exports = {
...
},{"./jquery":22}],30:[function(require,module,exports){
"use strict";
var views = {};
...
views['popup']['media'] = Handlebars.template({
    ...
    '5': function (depth0, helpers, partials, data) {
        return ' instashow-popup-media-carousel';
    },
    '7': function (depth0, helpers, partials, data) {
        var stack1;
    ...
    '9': function (depth0, helpers, partials, data) {
        ...
        return '<video poster="' + alias2(alias1((stack1 = (stack1 = (stack1 = depth0 != null ? depth0.media : depth0) != null ? stack1.images : stack1) != null ? stack1.standard_resolution : stack1) != null ? stack1.url : stack1, depth0)) + '" src="' + alias2(alias1((stack1 = depth0 != null ? depth0.media : depth0) != null ? stack1.video_url : stack1, depth0)) + '" preload="false" loop webkit-playsinline></video>';
    },
    '11': function (depth0, helpers, partials, data) {
        var helper;
        return ' ' + this.escapeExpression((helper = (helper = helpers.carousel || (depth0 != null ? depth0.carousel : depth0)) != null ? helper : helpers.helperMissing, typeof helper === 'function' ? helper.call(depth0, {
            'name': 'carousel',
            'hash': {},
            'data': data
        }) : helper)) + ' ';
    ...
    '13': function (depth0, helpers, partials, data) {
        var stack1, helper;
        return '<div class="instashow-popup-media-info-container"> ' + ((stack1 = (helper = (helper = helpers.info || (depth0 != null ? depth0.info : depth0)) != null ? helper : helpers.helperMissing, typeof helper === 'function' ? helper.call(depth0, {
            'name': 'info',
            'hash': {},
            'data': data
        }) : helper)) != null ? stack1 : '') + '<div class="instashow-popup-media-info-loader"><div class="instashow-spinner"></div></div></div> ';
    },
    'compiler': [
        6,
        '>= 2.0.0-beta.1'
    ...
    'main': function (depth0, helpers, partials, data) {
        ...
        return '<div class="instashow-popup-media' + ((stack1 = helpers['if'].call(depth0, (stack1 = depth0 != null ? depth0.options : depth0) != null ? stack1.comments : stack1, {
            ...
            'inverse': this.noop,
            'data': data
        })) != null ? stack1 : '') + ((stack1 = helpers['if'].call(depth0, (stack1 = depth0 != null ? depth0.options : depth0) != null ? stack1.isCarousel : stack1, {
            'name': 'if',
            'hash': {},
            'fn': this.program(5, data, 0),
            'inverse': this.noop,
...
views['popup']['mediaCarousel'] = Handlebars.template({
    '1': function (depth0, helpers, partials, data) {
        var stack1, helper;
        return '<div class="instashow-popup-media-carousel-nav-item' + ((stack1 = helpers.unless.call(depth0, data && data.index, {
            'name': 'unless',
            'hash': {},
            'fn': this.program(2, data, 0),
            'inverse': this.noop,
            'data': data
        })) != null ? stack1 : '') + '" data-media-url="' + this.escapeExpression((helper = (helper = helpers.display_url || (depth0 != null ? depth0.display_url : depth0)) != null ? helper : helpers.helperMissing, typeof helper === 'function' ? helper.call(depth0, {
            'name': 'display_url',
            'hash': {},
            'data': data
        }) : helper)) + '"></div> ';
    ...
    '2': function (depth0, helpers, partials, data) {
        return ' instashow-popup-media-carousel-nav-item-active';
    },
    'compiler': [
        6,
        '>= 2.0.0-beta.1'
    ...
    'main': function (depth0, helpers, partials, data) {
        var stack1;
        return '<div class="instashow-popup-media-carousel-nav"> ' + ((stack1 = helpers.each.call(depth0, (stack1 = depth0 != null ? depth0.media : depth0) != null ? stack1.carousel : stack1, {
            'name': 'each',
            'hash': {},
            'fn': this.program(1, data, 0),
            'inverse': this.noop,
...
views['popup']['mediaInfo'] = Handlebars.template({
    '1': function (depth0, helpers, partials, data) {
        var stack1;
    ...
    '4': function (depth0, helpers, partials, data) {
        ...
        return ' <a href="' + alias1(this.lambda((stack1 = depth0 != null ? depth0.media : depth0) != null ? stack1.link : stack1, depth0)) + '" target="_blank" rel="nofollow" class="instashow-popup-media-info-original">' + alias1((helper = (helper = helpers.viewOnInstagram || (depth0 != null ? depth0.viewOnInstagram : depth0)) != null ? helper : helpers.helperMissing, typeof helper === 'function' ? helper.call(depth0, {
    ...
    '8': function (depth0, helpers, partials, data) {
        var helper;
        return '<span class="instashow-popup-media-info-properties-item"><span class="instashow-icon instashow-icon-like"></span> <em>' + this.escapeExpression((helper = (helper = helpers.likesCount || (depth0 != null ? depth0.likesCount : depth0)) != null ? helper : helpers.helperMissing, typeof helper === 'function' ? helper.call(depth0, {
            'name': 'likesCount',
            'hash': {},
            'data': data
        }) : helper)) + '</em></span> ';
    ...
    '10': function (depth0, helpers, partials, data) {
        var helper;
        return '<span class="instashow-popup-media-info-properties-item"><span class="instashow-icon instashow-icon-comment"></span> <em>' + this.escapeExpression((helper = (helper = helpers.commentsCount || (depth0 != null ? depth0.commentsCount : depth0)) != null ? helper : helpers.helperMissing, typeof helper === 'function' ? helper.call(depth0, {
            'name': 'commentsCount',
            'hash': {},
            'data': data
        }) : helper)) + '</em></span> ';
    ...
    '12': function (depth0, helpers, partials, data) {
        var helper;
        return '<span class="instashow-popup-media-info-properties-item-location instashow-popup-media-info-properties-item"><span class="instashow-icon instashow-icon-placemark"></span> <em>' + this.escapeExpression((helper = (helper = helpers.location || (depth0 != null ? depth0.location : depth0)) != null ? helper : helpers.helperMissing, typeof helper === 'function' ? helper.call(depth0, {
            'name': 'location',
            'hash': {},
            'data': data
        }) : helper)) + '</em></span> ';
    ...
    '14': function (depth0, helpers, partials, data) {
        var helper;
        return '<div class="instashow-popup-media-info-passed-time">' + this.escapeExpression((helper = (helper = helpers.passedTime || (depth0 != null ? depth0.passedTime : depth0)) != null ? helper : helpers.helperMissing, typeof helper === 'function' ? helper.call(depth0, {
            'name': 'passedTime',
            'hash': {},
            'data': data
        }) : helper)) + '</div> ';
    ...
    '19': function (depth0, helpers, partials, data) {
        var stack1, helper;
        return ' ' + ((stack1 = (helper = (helper = helpers.comments || (depth0 != null ? depth0.comments : depth0)) != null ? helper : helpers.helperMissing, typeof helper === 'function' ? helper.call(depth0, {
            'name': 'comments',
            'hash': {},
            'data': data
        }) : helper)) != null ? stack1 : '') + ' ';
...
views['style'] = Handlebars.template({
    ...
    'main': function (depth0, helpers, partials, data) {
        ...
        return '<style type="text/css">\n    #instaShowGallery_' + alias3((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias1, typeof helper === alias2 ? helper.call(depth0, {
            ...
            'hash': {},
            'data': data
        }) : helper)) + ' .instashow-popup-media-info-author-picture img {\n        border-color: ' + alias3((helper = (helper = helpers.colorPopupBg || (depth0 != null ? depth0.colorPopupBg : depth0)) != null ? helper : alias1, typeof helper === alias2 ? helper.call(depth0, {
            'name': 'colorPopupBg',
            'hash': {},
            'data': data
        }) : helper)) + ';\n    }\n\n    #instaShowPopup_' + alias3((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias1, typeof helper === alias2 ? helper.call(depth0, {
            ...
            'hash': {},
            'data': data
        }) : helper)) + ' .instashow-popup-media-info-content .instashow-popup-media-info-description-author,\n    #instaShowPopup_' + alias3((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias1, typeof helper === alias2 ? helper.call(depth0, {
            'name': 'id',
            'hash': {},
            'data': data
        }) : helper)) + ' .instashow-popup-media-info-content .instashow-popup-media-info-comments-item-author {\n        color: ' + alias3((helper = (helper = helpers.colorPopupUsername || (depth0 != null ? depth0.colorPopupUsername : depth0)) != null ? helper : alias1, typeof helper === alias2 ? helper.call(depth0, {
            ...
            'hash': {},
            'data': data
        }) : helper)) + ' .instashow-popup-media-info-content .instashow-popup-media-info-description-author:hover,\n    #instaShowPopup_' + alias3((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias1, typeof helper === alias2 ? helper.call(depth0, {
            'name': 'id',
            'hash': {},
            'data': data
        }) : helper)) + ' .instashow-popup-media-info-content .instashow-popup-media-info-comments-item-author:hover {\n        color: ' + alias3((helper = (helper = helpers.colorPopupUsernameHover || (depth0 != null ? depth0.colorPopupUsernameHover : depth0)) != null ? helper : alias1, typeof helper === alias2 ? helper.call(depth0, {
            ...
            'hash': {},
            'data': data
        }) : helper)) + ' a.instashow-popup-media-info-original {\n        background: ' + alias3((helper = (helper = helpers.colorPopupInstagramLink || (depth0 != null ? depth0.colorPopupInstagramLink : depth0)) != null ? helper : alias1, typeof helper === alias2 ? helper.call(depth0, {
            ...
            'hash': {},
            'data': data
        }) : helper)) + ' a.instashow-popup-media-info-original:hover {\n        background: ' + alias3((helper = (helper = helpers.colorPopupInstagramLinkHover || (depth0 != null ? depth0.colorPopupInstagramLinkHover : depth0)) != null ? helper : alias1, typeof helper === alias2 ? helper.call(depth0, {
