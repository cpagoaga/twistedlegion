...
class EnlivenEmSvgSanitizer {
	...
	function __construct() {
		global $enlivenem_whitelist_elems;
		global $enlivenem_whitelist_attrs;
		...
		self::$whitelist_elems = $enlivenem_whitelist_elems;
		self::$whitelist_attrs = $enlivenem_whitelist_attrs;
	}
