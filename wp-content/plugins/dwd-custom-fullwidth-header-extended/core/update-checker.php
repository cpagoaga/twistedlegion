...
if (!class_exists('DWD_FHE_PluginUpdateChecker')):

require 'plugin-update-checker.php';

class DWD_FHE_PluginUpdateChecker extends Puc_v4_Plugin_UpdateChecker {
...
// 		add_filter('plugin_row_meta', array($this, 'displayUpdateCredentialsLink'), 9, 2);
	...
	public function addCredentialCheckScripts() {
		wp_register_script( 'dwd-updatecheck', plugins_url('/js/updatecheck.js', __FILE__), array('jquery'));
		wp_enqueue_script( 'dwd-updatecheck');
	}
	
	public function addCredentialCheckStyles() {
		wp_register_style( 'dwd-updatecheck', plugins_url('/css/updatecheck.css', __FILE__));
		wp_enqueue_style( 'dwd-updatecheck');
	}
