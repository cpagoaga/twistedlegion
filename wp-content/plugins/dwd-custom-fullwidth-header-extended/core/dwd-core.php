...
if ( ! defined( 'DWD_AIO_ITEM_REFERENCE' ) ) {
    define('DWD_AIO_ITEM_REFERENCE', 'Divi AIO Extended'); //Rename this constant name so it is specific to your plugin or theme.
}
// This is a value that will be recorded in the license manager data so you can identify licenses for this item/product.
...
function dwd_management_page(){
    ...
    <div class='wrap'>
	    ...
	    <p>This will be reserve for future Divi tweaks plans. You can contact hello@diviwebdesign.com for any enquiries.</p>
    ...
    <?php } /** End FHE**/
        ...
        if ( is_plugin_active('dwd-aio-module-extended-plugin/load_aio_module.php') ) {
            ...
            if ( $aio_activated == 'activated' ) {
                echo '<div class="notice notice-success"><p>Your All-In-One Extended Module is Activated!</p></div>';
            }
            //check
            ...
            <form action="" method="post">
                <tr <?php if ( $aio_activated == 'activated' ) { echo 'class="active"'; } else { echo 'class="inactive"'; } ?>>
                    <td style="vertical-align:middle"><label for="aio_license_key">All-In-One Extended Module</label></td>
